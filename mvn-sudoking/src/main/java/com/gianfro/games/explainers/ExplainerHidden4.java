...
public class ExplainerHidden4 {
    ...
    public static void main(String[] args) {
        ...
        Sudoku sudoku;
//        sudoku = Sudoku.fromString(SudokuList.TEST_HIDDEN_4_BOX);
//        sudoku = Sudoku.fromString(SudokuList.TEST_HIDDEN_4_ROW);
        sudoku = Sudoku.fromString(SudokuList.TEST_HIDDEN_4_COL);
//        sudoku = Sudoku.fromString("650087024000649050040025000570438061000501000310902085000890010000213000130750098"); // TEST COL 7 STRONZO ENG RICHIEDE XY-WING

        Utils.megaGrid(sudoku);

        Set<ChangeLog> changeLogs = Hidden4.check(sudoku);
