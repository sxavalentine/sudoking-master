...
public class DiscontinuousNiceLoop {
    ...
    /**
     * DISCONTINUOUS NICE LOOP must start and end with a strong link on the same cell. A strong link is a "If A is false then B is true".
                ...
                for (int houseNumber : Utils.NUMBERS) {
                    ...
                    if (welcomingTabs.size() == 2) {
                        ...
                        try {
                            ...
                            // where it cn't find the following Discontinuous Alternating Nice Loop, length 8:
