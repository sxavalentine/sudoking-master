...
public class XChain {
    ...
    /**
     * X CHAINS must start and end with a strong link. A strong link is an "If A is false then B is true". So they always need to have an even numbers of links"
     */
...
//                            }
                            ...
                            // where it can't find the X-CHAIN on 6 (Discontinuous Alternating Nice Loop, length 8):
